                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-flat btn-primary btn-xs" data-toggle="modal"
                            data-target="#edit<?= $value['id_penghasilan'] ?>"><i class=" fas
                    fa-user-edit"></i></button>
                        <button class="btn btn-flat btn-info btn-xs" data-toggle="modal"
                            data-target="#delete<?= $value['id_penghasilan'] ?>"><i class=" fas
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambahkan Penghasilan</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Penghasilan</label>
                    <input name="penghasilan" value="<?= $value['penghasilan'] ?>" class="form-control"
                        placeholder="Ex:Rp.0 - Rp.500.000" required>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="<?= base_url('penghasilan/deleteData/' . $value['id_penghasilan']); ?>"
