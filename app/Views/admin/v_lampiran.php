    ...
    <div class="card card-warning">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button class="btn btn-flat btn-primary btn-bs" data-toggle="modal" data-target="#add"><i class=" fa
        ...
        <table class="table table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-flat btn-secondary btn-xs" data-toggle="modal"
                            data-target="#edit<?= $value['id_lampiran'] ?>"><i class=" fas
                    fa-edit"></i></button>
                        <button class="btn btn-flat btn-success btn-xs" data-toggle="modal"
                            data-target="#delete<?= $value['id_lampiran'] ?>"><i class=" fas
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input name="lampiran" class="form-control" placeholder="Tamabahkan lampiran" required>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Lampiran</label>
                    <input name="lampiran" value="<?= $value['lampiran'] ?>" class="form-control" placeholder="lampiran"
                        required>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="<?= base_url('lampiran/deleteData/' . $value['id_lampiran']); ?>"
