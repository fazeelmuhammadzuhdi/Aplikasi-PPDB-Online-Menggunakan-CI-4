                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-flat btn-secondary btn-xs" data-toggle="modal"
                            data-target="#edit<?= $value['id_pekerjaan'] ?>"><i class=" fas
                    fa-pen-square"></i></button>
                        <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal"
                            data-target="#delete<?= $value['id_pekerjaan'] ?>"><i class=" fas
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambahkan Pekerjaan</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Pekerjaan</label>
                    <input name="pekerjaan" value="<?= $value['pekerjaan'] ?>" class="form-control"
...
<div class="modal fade" id="delete<?= $value['id_pekerjaan'] ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">Close</button>
                <a href="<?= base_url('pekerjaan/deleteData/' . $value['id_pekerjaan']); ?>"
