    ...
    <div class="card card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button class="btn btn-flat btn-warning btn-bs" data-toggle="modal" data-target="#add"><i class=" fas
                    fa-search-location"></i> Add </button>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-flat btn-success btn-xs" data-toggle="modal"
                            data-target="#edit<?= $value['id_pendidikan'] ?>"><i class=" fas
                    fa-user-edit"></i></button>
                        <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal"
                            data-target="#delete<?= $value['id_pendidikan'] ?>"><i class=" fas
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambahkan Pendidikan</h4>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input name="pendidikan" class="form-control" placeholder="Masukkan Pendidikan" required>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Pendidikan</label>
                    <input name="pendidikan" value="<?= $value['pendidikan'] ?>" class="form-control"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="<?= base_url('pendidikan/deleteData/' . $value['id_pendidikan']); ?>"
