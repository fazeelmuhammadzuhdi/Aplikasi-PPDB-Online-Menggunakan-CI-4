                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="nama_lengkap" value="<?= old('nama_lengkap') ?>" class="form-control"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="nama_panggilan" value="<?= old('nama_panggilan') ?>" class="form-control"
                                placeholder="Nama Panggilan">
                            <p class="text-danger">
                                <?= $validation->hasError('nama_panggilan') ? $validation->getError('nama_panggilan') : '' ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <p class="text-danger">
                                <?= $validation->hasError('jk') ? $validation->getError('jk') : '' ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        <button type="submit" class="btn btn-info btn-flat btn-block"> <i class="fas fa-save"></i>
                            Submit </button>
                    </div>
                </div>
            </div>
...
<div class="col-sm-12">
    <div class="alert alert-warning alert-dismissible">
        <h5><i class="icon fas fa-exclamation-triangle"></i> Pemeberitahuan!</h5>
