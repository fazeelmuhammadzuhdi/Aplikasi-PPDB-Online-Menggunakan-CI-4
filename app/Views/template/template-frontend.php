...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url() ?>/AdminLTE/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
    <!-- BS Stepper -->
...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand-md navbar-success navbar-navy">
            <div class="container">
                <a href="../../index3.html" class="navbar-brand">
                    <img src="<?= base_url() ?>/logo/<?= $setting['logo']; ?>" width="50px" height="50px">
                    <span class="brand-text font-weight-light"><b>PPDB ONLINE <?= $setting['nama_sekolah'] ?> </b>
                    </span>
                </a>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <?= session()->get('nama_lengkap') ?></a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="<?= base_url('Siswa') ?>" class="dropdown-item"> Biodata</a></li>
                            <li class="dropdown-divider"></li>
                            <li><a href="<?= base_url('Auth/logout_siswa') ?>" class="dropdown-item"> <i
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <?php if ($ta['status'] <> 1) { ?>
                            <h1 class="text-danger"> <b> Pendaftaran Telah Ditutup !!! </b> </h1>
                            <?php } else { ?>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?= date('Y') ?> <a href="<?= $setting['web'] ?>"> <?= $setting['nama_sekolah'] ?>
                </a>.</strong> All rights
            reserved.
        </footer>
    </div>
    ...
    <!-- Bootstrap4 Duallistbox -->
    <script src="<?= base_url() ?>/AdminLTE/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js">
    </script>
    <!-- InputMask -->
