               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-comments-dollar text-info"></i>
                                <p>
                                    Master Data
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('jurusan') ?>" class="nav-link">
                                        <i class="nav-icon fas fa-book text-black"></i>
                                        <p>Jurusan</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('pekerjaan') ?>" class="nav-link">
                                        <i class="nav-icon fas fa-suitcase-rolling text-danger"></i>
                                        <p>Pekerjaan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('agama') ?>" class="nav-link">
                                        <i class="nav-icon fas fa-praying-hands text-white"></i>
                                        <p>Agama</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-registered text-warning"></i>
                                <p>
                                    Pendaftaran
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('ppdb/laporan') ?>" class="nav-link">
                                <i class="nav-icon fas fa-clipboard text-danger"></i>
                                <p>Laporan</p>
                            </a>
                        </li>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('ta') ?>" class="nav-link">
                                        <i class="nav-icon fas fa-calendar text-purple"></i>
                                        <p>Tahun Ajaran</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/setting') ?>" class="nav-link">
                                        <i class="fas fa-cog text-warning nav-icon"></i>
                                        <p>Setting Web</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Baner') ?>" class="nav-link">
                                        <i class="fas fa-bullhorn text-primary  nav-icon"></i>
                                        <p>Setting Banner</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/beranda') ?>" class="nav-link">
                                        <i class="fas fa-bread-slice text-success  nav-icon"></i>
                                        <p>Setting Beranda</p>
                                    </a>
                                </li>
                            </ul>
