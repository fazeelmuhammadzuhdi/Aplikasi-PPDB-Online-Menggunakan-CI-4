    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            ...
            foreach ($baner as $key => $value) {
                $a = $no_a;
            ?>
            <li data-target="#carouselExampleIndicators" data-slide-to="<?= $no_a++ ?>"
                class="<?= ($no_a == 1) ? 'active' : '' ?>"></li>
            <?php } ?>
        </ol>
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?= ($b == 1) ? 'active' : '' ?>">
                <img class="d-block w-100" height="420px" src="<?= base_url('assets/' . $value['baner']) ?>"
                    alt="<?= $no_b++ ?>">
            </div>
            <?php } ?>
        </div>
    ...
    <div class="col-md-12 col-sm-12 col-12">
        <div class="card card-primary card-outline ">
            <div class="card-header">
                <h3 class="card-title"><b>Estimasi Pendaftar Tahun <?= date('Y') ?></b></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="col-md-12 col-sm-12 col-12">
                ...
                <div class="col-md-12 col-sm-12 col-12">
                    <a href="<?= base_url('/Pendaftaran') ?>" class="btn btn-info btn-flat btn-block"> <i
                            class="fas fa-file-alt"></i> Mendaftar </a>
                </div>
            </div>
        </div>
    </div>
