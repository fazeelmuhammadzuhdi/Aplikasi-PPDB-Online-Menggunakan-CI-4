...
class Siswa extends BaseController
{
	...
	public function updatePendaftaran($id_siswa)
	{
		...
		session()->setFlashdata('pesan', 'Data Pendaftaran Berhasil DiUpdate !!!');
	...
	public function updateIdentitasSiswa($id_siswa)
	{
		...
		$this->ModelSiswa->editData($data);
		session()->setFlashdata('pesan', 'Identitas Siswa Berhasil DiUpdate !!!');
		return redirect()->to('/Siswa');
	}
	...
	public function updateDataAyah($id_siswa)
	{
		...
		$this->ModelSiswa->editData($data);
		session()->setFlashdata('pesan', 'Data Ayah Berhasil DiUpdate !!!');
		return redirect()->to('/Siswa');
	}
	...
	public function updateDataIbu($id_siswa)
	{
		...
		$this->ModelSiswa->editData($data);
		session()->setFlashdata('pesan', 'Data Ibu Berhasil DiUpdate !!!');
		return redirect()->to('/Siswa');
	}
	...
	public function updateDataAlamat($id_siswa)
	{
		...
		$this->ModelSiswa->editData($data);
		session()->setFlashdata('pesan', 'Data Alamat Berhasil DiUpdate !!!');
		return redirect()->to('/Siswa');
	}
