...
class Admin extends BaseController
{
	...
	public function index()
	{
		$data = [
			...
			'pekerjaan' => $this->ModelAdmin->pekerjaan(),
			'agama' => $this->ModelAdmin->agama(),
			'pendidikan' => $this->ModelAdmin->pendidikan(),
			'penghasilan' => $this->ModelAdmin->penghasilan(),
			'user' => $this->ModelAdmin->user(),
			'masuk' => $this->ModelAdmin->masuk(),
			'diterima' => $this->ModelAdmin->diterima(),
			'ditolak' => $this->ModelAdmin->ditolak(),
		];
